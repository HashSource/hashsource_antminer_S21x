...
; uselistorder directives
  ...
  uselistorder i32 (%_IO_FILE*)* @fclose, { 13, 12, 4, 11, 2, 1, 0, 10, 9, 3, 8, 7, 6, 5, 14 }
  ...
  uselistorder i32 (i32*, i32, i32, %_IO_FILE*)* @fwrite, { 1, 0, 5, 4, 3, 2, 6 }
  uselistorder i32 (i32*, i32*, i32)* @SHA256_Update, { 4, 3, 2, 1, 0, 5 }
  uselistorder i32 (i32*, i32, i32, %_IO_FILE*)* @fread, { 0, 5, 4, 3, 2, 1, 6 }
  ...
  uselistorder i32* (i32*, i32, i32)* @memset, { 5, 10, 9, 8, 7, 6, 4, 3, 2, 1, 0, 11 }
...
; uselistorder directives
  uselistorder i32 (i8*, ...)* @printf, { 7, 6, 16, 15, 14, 13, 12, 11, 10, 9, 8, 5, 4, 3, 2, 1, 0, 17 }
  uselistorder i32 (i8*)* @puts, { 0, 17, 15, 13, 3, 1, 22, 23, 26, 4, 14, 16, 5, 24, 6, 8, 12, 7, 2, 11, 19, 20, 21, 9, 10, 18, 25, 27 }
}

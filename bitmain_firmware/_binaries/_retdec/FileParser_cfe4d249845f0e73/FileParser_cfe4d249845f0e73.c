...
int32_t function_11f90(uint32_t i_a1, int32_t i_a2);
int32_t function_122fc(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_12338(void);
int32_t function_1233c(int32_t i_a1, int32_t *p_a2);
int32_t function_12340(void);
int32_t function_12348(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t unknown_240(void);

// --------------------- Global Variables ---------------------

int32_t i_g1 = -0x1cae0000; // 0x10878
int32_t i_g2 = 0;           // 0x12788
int32_t i_g3 = 0x108f5;     // 0x22f08
int32_t i_g4 = 256;         // 0x2307c
char *p_g5;                 // 0x23838
uint32_t i_g6;
int32_t i_g7;
int32_t i_g8;
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    __libc_start_main(0x11f90, i_a2, (char **)&i_v1, (void (*)())0x122fd,
                      (void (*)())0x11f90, (void (*)())i_a1);
    abort();
    // UNREACHABLE
}
...
int32_t function_10868(void) {
    int32_t i_v1 =
        *(int32_t *)((int32_t)&i_g1 + (int32_t)&i_g2 + 112); // 0x10874
    if (i_v1 == 0) {
...
int32_t function_109a8(int32_t *p_a1) {
    ...
    int32_t *p_v6 = (int32_t *)(i_v5 + (int32_t)&i_g4); // 0x10a58
    fread(&i_v1, *p_v6, 1, p_v3);
    char *p_v7 = (char *)(i_v5 + (int32_t)&i_g4 + 4); // 0x10aa4
    ...
    while (p_v8 != NULL) {
        ...
        i_v5 = 132 * i_v4;
        p_v6 = (int32_t *)(i_v5 + (int32_t)&i_g4);
        fread(&i_v1, *p_v6, 1, p_v3);
        p_v7 = (char *)(i_v5 + (int32_t)&i_g4 + 4);
...
// Address range: 0x11460 - 0x11f90
int32_t function_11460(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       uint32_t i_a4, uint32_t i_a5, uint32_t i_a6) {
    // 0x11460
    int32_t i_v1; // bp-200, 0x11460
    function_1233c((int32_t)p_a1, &i_v1);
    ...
    int32_t i_v32 = 0; // bp-1224, 0x11830
    int32_t i_v33;     // bp-1220, 0x11460
    memset(&i_v33, 0, 1020);
    ...
    if (p_v39 != NULL) {
        int32_t i_v40 = i_v6 + 13;                  // 0x11924
        unsigned char i_v41 = *(char *)i_v40;       // 0x11924
        unsigned char i_v42 = *(char *)(i_v6 + 14); // 0x11930
        unsigned char i_v43 = *(char *)(i_v6 + 15); // 0x1193c
        unsigned char i_v44 = *(char *)(i_v6 + 16); // 0x11948
        unsigned char i_v45 = *(char *)(i_v6 + 17); // 0x11954
        unsigned char i_v46 = *(char *)(i_v6 + 18); // 0x11960
        unsigned char i_v47 = *(char *)(i_v6 + 19); // 0x1196c
        unsigned char i_v48 = *(char *)(i_v6 + 20); // 0x11978
        printf("fw version data: %02X %02X %02X %02X %02X %02X %02X %02X\n",
               (int32_t)i_v41, (int32_t)i_v42, (int32_t)i_v43, (int32_t)i_v44,
               (int32_t)i_v45, (int32_t)i_v46, (int32_t)i_v47, (int32_t)i_v48);
        fwrite((int32_t *)i_v40, 1, 8, p_v39);
        fclose(p_v39);
    }
    if (i_v11 != 0) {
        struct _IO_FILE *p_v49 =
            fopen64("/tmp/tmpfw/miner.pem", "w"); // 0x119e4
        if (p_v49 == NULL) {
            // 0x11a40
        ...
        // 0x119f8
        fwrite((int32_t *)i_v36, 1, i_v35, p_v49);
        fclose(p_v49);
        struct _IO_FILE *p_v50 =
            fopen64("/tmp/tmpfw/miner.pem.sig", "w"); // 0x11a28
        if (p_v50 == NULL) {
            // 0x11a7c
        ...
        // 0x11a54
        fwrite((int32_t *)i_v37, 1, 256, p_v50);
        fclose(p_v50);
    }
    // 0x11a90
    int32_t i_v51; // bp-2280, 0x11460
    memset(&i_v51, 0, 1056);
    int32_t i_v52; // bp-2392, 0x11460
    SHA256_Init(&i_v52);
    SHA256_Update(&i_v52, i_v6, 2048, &i_v52);
    SHA256_Final(&i_v51, &i_v52, &i_v52, &i_v51);
    int32_t i_v53 = &i_v51;
    if (i_v12 != 0) {
        int32_t i_v54 = i_v53 + 32;    // 0x11bc0
        int32_t i_v55 = (int32_t)p_v4; // 0x11c14
        for (int32_t i_v56 = 0; i_v56 < i_v21; i_v56++) {
            int32_t i_v57 = 5 * i_v56 + i_v6;              // 0x11b20
            unsigned char i_v58 = *(char *)(i_v57 + 1310); // 0x11b2c
            unsigned char i_v59 = *(char *)(i_v57 + 1311); // 0x11b54
            unsigned char i_v60 = *(char *)(i_v57 + 1312); // 0x11b7c
            unsigned char i_v61 = *(char *)(i_v57 + 1313); // 0x11ba8
            unsigned char i_v62 = *(char *)(i_v57 + 1309); // 0x11bf4
            function_10de8(i_v55,
                           0x10000 * (int32_t)i_v59 |
                               0x1000000 * (int32_t)i_v58 |
                               256 * (int32_t)i_v60 | (int32_t)i_v61,
                           i_v54 + 32 * i_v56, (int32_t)i_v62, 0, i_v11);
        }
        int32_t i_v63 = 0;
        int32_t i_v64 = i_v63 + 1;
        unsigned char i_v65 = *(char *)(i_v6 + 1309 + 5 * i_v63); // 0x11c88
        function_10de8(i_v55, 256, 32 * (i_v64 + i_v21) + i_v53, (int32_t)i_v65,
                       1, i_v11);
        while (i_v64 < i_v21) {
            // 0x11c44
            i_v63 = i_v64;
            i_v64 = i_v63 + 1;
            i_v65 = *(char *)(i_v6 + 1309 + 5 * i_v63);
            function_10de8(i_v55, 256, 32 * (i_v64 + i_v21) + i_v53,
                           (int32_t)i_v65, 1, i_v11);
        }
    }
    int32_t i_v66 = 0; // bp-2648, 0x11cd0
    int32_t i_v67;     // bp-2644, 0x11460
    memset(&i_v67, 0, 252);
    fseek(p_v4, -256, SEEK_END);
    fread(&i_v66, 256, 1, p_v4);
    int32_t i_v68 = 0; // bp-2680, 0x11d20
    int32_t i_v69;     // bp-2792, 0x11460
    SHA256_Init(&i_v69);
    SHA256_Update(&i_v69, i_v53, 64 * i_v21 | 32, &i_v69);
    SHA256_Final(&i_v68, &i_v69, &i_v69, &i_v68);
    int32_t i_v70 = BIO_new_mem_buf(i_v36, 1024);            // 0x11dd8
    int32_t i_v71 = PEM_read_bio_RSA_PUBKEY(i_v70, 0, 0, 0); // 0x11df0
    if (i_v71 == 0) {
        // 0x11e04
        printf("OpenSSL error: %s\n",
               (char *)ERR_error_string(ERR_get_error(0), 0));
    ...
    int32_t i_v72 =
        RSA_verify(672, &i_v68, 32, (int32_t)&i_v66, 256, i_v71); // 0x11e70
    RSA_free(i_v71);
    if (i_v70 != 0) {
        // 0x11e98
        BIO_free(i_v70);
    ...
    if (i_v72 != 1) {
        int32_t i_v73 =
            ERR_get_error(puts("Check File Sig failed!\r")); // 0x11eb8
        printf("OpenSSL error: %s\n", (char *)ERR_error_string(i_v73, 0));
        // 0x11f84
        return 18;
    }
    // 0x11ef4
    ...
    if (i_a5 % 256 != 0) {
        ...
        int32_t i_v74 = 0; // bp-3052, 0x11f2c
        int32_t i_v75;     // bp-3048, 0x11460
        memset(&i_v75, 0, 253);
        memcpy(&i_v74, (int32_t *)(i_v6 + 1360), 256);
        puts((char *)&i_v74);
    }
    // 0x11f84
    return 0;
...
int32_t function_11f90(uint32_t i_a1, int32_t i_a2) {
    ...
    int32_t *p_v1 = (int32_t *)(i_a2 + 4); // 0x11fd0
    if (*(char *)*p_v1 != 45) {
        // 0x122f0
        return 2;
    }
    int32_t i_v2 = 0; // bp-144, 0x11ffc
    int32_t i_v3;     // bp-140, 0x11f90
    memset(&i_v3, 0, 124);
    int32_t i_v4 = 0; // bp-272, 0x12018
    int32_t i_v5;     // bp-268, 0x11f90
    memset(&i_v5, 0, 124);
    int32_t i_v6; // bp-2320, 0x11f90
    memset(&i_v6, 0, 2048);
    int32_t i_v7; // bp-2576, 0x11f90
    memset(&i_v7, 0, 253);
    switch (i_a1) {
    case 5: {
        int32_t *p_v8 = (int32_t *)(i_a2 + 12); // 0x1209c
        uint32_t i_v9 = strlen((char *)*p_v8);  // 0x120a4
        ...
        int32_t *p_v10 = (int32_t *)(i_a2 + 16); // 0x120ec
        uint32_t i_v11 = strlen((char *)*p_v10); // 0x120f4
    ...
    case 2: {
    lab_0x121c8:;
        unsigned char i_v12 = *(char *)(*p_v1 + 1); // 0x121e0
        i_g7 = (int32_t)i_v12 - 102;
        char i_v13 = 0;    // 0x121ec
        char i_v14 = 1;    // 0x121ec
        int32_t i_v15 = 0; // 0x121ec
        int32_t i_v16 = 0; // 0x121ec
        char i_v17 = 0;    // 0x121ec
        char i_v18 = 0;    // 0x121ec
        int32_t i_v19;     // 0x11f90
        switch (i_v12) {
        case 120: {
            // 0x1225c
            i_v13 = 1;
    ...
    case 3: {
        int32_t *p_v21 = (int32_t *)(i_a2 + 8);  // 0x1214c
        uint32_t i_v22 = strlen((char *)*p_v21); // 0x12154
...
// Address range: 0x122fc - 0x12330
int32_t function_122fc(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_106e8(i_a1, i_a2, i_a3, i_a4); // 0x1230c
    return 0x22f0a - (int32_t)&i_g3 >> 2 == 0 ? i_v1 : i_a1;
}

// Address range: 0x12338 - 0x1233a
int32_t function_12338(void) {
    // 0x12338
    int32_t i_v1; // 0x12338
    return i_v1;
}

// Address range: 0x1233c - 0x12340
int32_t function_1233c(int32_t i_a1, int32_t *p_a2) {
    // 0x1233c
    return i_a1;
}

// Address range: 0x12340 - 0x12346
int32_t function_12340(void) {
    // 0x12340

...
int32_t function_10d7c(int32_t i_a1, int32_t i_a2);
...
int32_t function_10f38(int32_t *p_a1, uint32_t i_a2, int32_t i_a3,
                       int32_t i_a4);
int32_t function_11074(int32_t *p_a1, int32_t i_a2);
int32_t function_11138(int32_t i_a1, int32_t i_a2);
int32_t function_11190(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t *p_a4);
int32_t function_11314(int32_t *p_a1);
int32_t function_11340(int32_t i_a1);
int32_t function_11360(int32_t i_a1, uint32_t i_a2);
int32_t function_11444(int32_t i_a1, uint32_t i_a2, int32_t i_a3);
int32_t function_11510(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_1154c(void);
int32_t function_11550(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
...
lab_0x10a50:
    ...
    if (function_11190(i_v17, i_v25, i_v23, &i_v27) < 0) {
        // 0x10d38
    ...
    case 114: {
        ...
        // 0x10c70
        function_10f38(&i_v27, i_v29, i_v28, i_v3);
        // 0x10b3c
        function_11314(&i_v27);
        // 0x10b44
        return 0;
    }
    case 119: {
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    __libc_start_main(0x10920, i_a2, (char **)&i_v1, (void (*)())0x11511,
...
int32_t function_10ea0(int32_t i_a1, int32_t *p_a2, int32_t *p_a3) {
    ...
    *p_a2 = i_v2;
    ...
    char *p_v3 = (char *)((int32_t)p_v1 + 1); // 0x10ee8
    p_v1 = p_v3;
    int32_t i_v4 = strtoul(p_v3, NULL, 0); // 0x10eec
    *p_a3 = i_v4;
    return i_v4;
}

// Address range: 0x10efc - 0x10f38
int32_t function_10efc(void) {
    // 0x10efc
    fwrite(
        (int32_t
...
// Address range: 0x10f38 - 0x11074
int32_t function_10f38(int32_t *p_a1, uint32_t i_a2, int32_t i_a3,
                       int32_t i_a4) {
    int32_t i_v1 = (int32_t)p_a1;
    int32_t i_v2 = function_11360(i_v1, i_a2 % 0x10000); // 0x10f54
    if (i_v2 < 0) {
        // 0x11064
    ...
    int32_t i_v3 = i_a2; // 0x10f9c
    uint32_t i_v4 = 1;   // 0x10f9c
    int32_t i_v5 = i_a3; // 0x10f9c
    if (i_a3 == 1) {
        if (i_a4 == 0) {
            // 0x10ff8
            fflush(p_g6);
    ...
    while (true) {
        int32_t i_v6 = function_11340(i_v1); // 0x10fa4
        if (i_v6 < 0) {
            // break (via goto) -> 0x11054
            goto lab_0x11054;
        }
        // 0x10fb0
        i_v5--;
        while (i_a4 != 0) {
            int32_t i_v7 = i_v3 + 1; // 0x10fbc
            if (i_v4 % 16 == 0) {
                // 0x11020
                printf("\n %.4x|  ", i_v7);
            } else {
...
// Address range: 0x11074 - 0x11138
int32_t function_11074(int32_t *p_a1, int32_t i_a2) {
    int32_t i_v1 = i_a2;            // 0x110a0
    uint32_t i_v2 = _IO_getc(p_g5); // 0x110cc
    while (i_v2 != -1) {
        // 0x110e0
        if (i_g8 == 0) {
            // 0x110e8
        ...
        // 0x110a4
        fflush(p_g6);
        int32_t i_v3 = function_11444((int32_t)p_a1, i_v1 % 0x10000,
                                      i_v2 % 256); // 0x110bc
        i_v1++;
        if (i_v3 != 0) {
            // 0x11128
...
// Address range: 0x11138 - 0x11190
int32_t function_11138(int32_t i_a1, int32_t i_a2) {
    int32_t i_v1 = i2c_smbus_write_byte_data(); // 0x11144
    if (i_v1 < 0) {
        // 0x11160
...
// Address range: 0x11190 - 0x11314
int32_t function_11190(int32_t i_a1, int32_t i_a2, int32_t i_a3,
                       int32_t *p_a4) {
    int32_t i_v1 = (int32_t)p_a4;
    int32_t *p_v2 = (int32_t *)(i_v1 + 4); // 0x111a8
    *p_v2 = 0;
    int32_t *p_v3 = (int32_t *)(i_v1 + 8); // 0x111b0
    *p_v3 = 0;
    *p_a4 = 0;
    int32_t i_v4 = open64((char *)i_a1, 2); // 0x111bc
    if (i_v4 < 1) {
        // 0x1123c
        return -1;
    }
    int32_t i_v5 = ioctl(i_v4, 1797); // 0x111d0
    if (i_v5 < 0) {
        // 0x1123c
        return i_v5;
    }
    ...
    int32_t i_v7 = ioctl(i_v4, 1795); // 0x1121c
    int32_t i_v8 = i_v7;              // 0x11224
    if (i_v7 >= 0) {
        // 0x11228
        *p_v3 = i_v4;
        *p_v2 = i_a2;
...
// Address range: 0x11314 - 0x11340
int32_t function_11314(int32_t *p_a1) {
    int32_t i_v1 = (int32_t)p_a1;
    int32_t *p_v2 = (int32_t *)(i_v1 + 8); // 0x1131c
    close(*p_v2);
    *p_v2 = -1;
    *p_a1 = 0;
    *(int32_t *)(i_v1 + 12) = 0;
...
// Address range: 0x11340 - 0x11360
int32_t function_11340(int32_t i_a1) {
    int32_t *p_v1 = (int32_t *)(i_a1 + 8); // 0x1134c
    ioctl(*p_v1, 0x1261);
    return i2c_smbus_read_byte(*p_v1);
}

// Address range: 0x11360 - 0x11444
int32_t function_11360(int32_t i_a1, uint32_t i_a2) {
    int32_t *p_v1 = (int32_t *)(i_a1 + 8); // 0x11374
    ioctl(*p_v1, 0x1261);
    int32_t i_v2; // 0x11360
    switch (*(int32_t *)(i_a1 + 12)) {
    case 1: {
        int32_t i_v3 = i2c_smbus_write_byte(*p_v1, i_a2 % 256); // 0x113d4
        if (i_v3 < 0) {
            // 0x113ec
...
// Address range: 0x11444 - 0x11510
int32_t function_11444(int32_t i_a1, uint32_t i_a2, int32_t i_a3) {
    // 0x11444
    int32_t i_v1; // 0x11474
    switch (*(int32_t *)(i_a1 + 12)) {
    case 1: {
        // 0x114c4
    ...
    case 2: {
        uint32_t i_v2 = i_a2 % 256;            // 0x11464
        int32_t i_v3 = *(int32_t *)(i_a1 + 8); // 0x11468
        int32_t i_v4;                          // 0x11444
...
// Address range: 0x11510 - 0x11544
int32_t function_11510(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_107bc(i_a1, i_a2, i_a3, i_a4); // 0x11520
    int32_t i_v2 =
        (int32_t) "address 0x33\n\t\tdate | eeprog /dev/i2c-0 0x33 -w 0x200\n" +
                        0x11520 - (int32_t)&i_g1 >>
                    2 ==
                0
            ? i_v1
            : i_a1;
...
// Address range: 0x1154c - 0x1154e
int32_t function_1154c(void) {
    // 0x1154c
    int32_t i_v1; // 0x1154c
    return i_v1;
}

// Address range: 0x11550 - 0x11558
int32_t function_11550(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    // 0x11550
    return i_a1;
}

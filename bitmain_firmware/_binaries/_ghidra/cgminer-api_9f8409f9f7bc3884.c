// Decompiled: cgminer-api_9f8409f9f7bc3884
...

{
    ...
    __libc_start_main(&DAT_0001072c, in_stack_00000000, &stack0x00000004,
                      0x10e5d, &DAT_00010e99, param_1);
...
/* WARNING: Removing unreachable block (ram,0x00010932) */

void FUN_00010914(void)
...
/* WARNING: Removing unreachable block (ram,0x0001095e) */
...
void FUN_000109f0(char *param_1)
...
ssize_t FUN_00010b84(char *param_1, char *param_2, uint param_3)

{
    ...
    if (phVar1 == (hostent *)0x0) {
        ...
        local_3c = 1;
        local_38 = 5;
        setsockopt(__fd, 1, 9, &local_3c, 4);
        setsockopt(__fd, 6, 1, &local_3c, 4);
        setsockopt(__fd, 6, 6, &local_3c, 4);
        setsockopt(__fd, 6, 4, &local_38, 4);
        setsockopt(__fd, 6, 5, &local_34, 4);
        ...
        if (pcVar5 == (char *)0x0) {
            ...
            do {
                do {
                    __buf = pcVar5 + iVar8;
                    sVar9 = recv(__fd, __buf, iVar2 - iVar8, 0);
                    iVar8 = iVar8 + sVar9;
                    if (sVar9 < 0) {
                        piVar6 = __errno_location();
                        sVar9 = 1;
...
void FUN_00010e5c(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)

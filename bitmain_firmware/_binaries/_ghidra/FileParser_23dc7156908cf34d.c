// Decompiled: FileParser_23dc7156908cf34d
...

{
    ...
    __libc_start_main(FUN_00013808, in_stack_00000000, &stack0x00000004,
                      0x13bed, &DAT_00013c29, param_1);
...

{
    ...
    undefined4 uVar5;
    char local_bfc[260];
    SHA256_CTX SStack_af8;
    uchar local_a88[32];
    undefined4 local_a68;
    undefined1 auStack_a64[252];
    SHA256_CTX SStack_968;
    uchar auStack_8f8[1056];
    undefined4 local_4d8;
    undefined1 auStack_4d4[1020];
    int local_d8;
    ...
    FUN_00013c2c(param_1, auStack_d0);
    local_2c = local_a0;
    if (local_a0 < 0x800) {
        ...
        if (local_30 == (FILE *)0x0) {
            ...
            fread(param_4, 0x800, 1, local_30);
            if (*param_4 == '&') {
                printf("miner_type %s\n", param_2);
                sVar1 = strlen(param_2);
                local_38 = FUN_00012180(param_2, sVar1);
                memcpy(&local_d8, param_4 + 2, 8);
                iVar4 = local_d8;
                uVar5 = uStack_d4;
                printf("miner_type_hash %16llx, bmu_hash %16llx\n");
                if (local_38 == CONCAT44(uStack_d4, local_d8)) {
                    local_11 = 0;
                    local_3a = CONCAT11(param_4[0xb], param_4[0xc]);
                    if (param_7 != '\0') {
                        printf("content:%x\n", (uint)local_3a,
                               (int)(short)((ushort)(byte)param_4[0xb] << 8),
                               (uint)local_3a, iVar4, uVar5);
                        if ((local_3a & 0xfe00) != 0xfe00) {
                    ...
                    for (local_18 = 0; (int)local_18 < 0x10;
                         local_18 = local_18 + 1) {
                        if (((int)(uint)local_3a >> (local_18 & 0xff) & 1U) !=
                            0) {
                            local_11 = local_11 + 1;
                        }
                    }
                    if (local_11 == param_4[0x518]) {
                        local_1c = ((byte)param_4[0x518] + 9) * 0x100;
                        local_40 = (uint)(byte)param_4[0x519] << 0x18 |
                        ...
                        for (local_20 = 0; local_20 < (int)(uint)local_11;
                             local_20 = local_20 + 1) {
                            local_68 =
                                (uint)(byte)param_4[local_20 * 5 + 0x51e]
                                    << 0x18 |
                                (uint)(byte)param_4[local_20 * 5 + 0x51f]
                                    << 0x10 |
                                (uint)(byte)param_4[local_20 * 5 + 0x520] << 8 |
                                (uint)(byte)param_4[local_20 * 5 + 0x521];
                            local_1c = local_1c + local_68;
                            printf("file[%d] size:[%d]\n", local_20, local_68,
                                   local_1c, iVar4, uVar5);
                        }
                        if (local_1c == local_2c) {
                            local_44 = fopen64(param_3, "r");
                            if (local_44 == (FILE *)0x0) {
                                ...
                                local_4d8 = 0;
                                memset(auStack_4d4, 0, 0x3fc);
                                fread(&local_4d8, 0x400, 1, local_44);
                                fclose(local_44);
                                local_44 = (FILE *)0x0;
                                local_48 = (uint)CONCAT11(param_4[0x16],
                                                          param_4[0x17]);
                                local_4c =
                                    FUN_00010c70(param_4 + 0x18, local_48,
                                                 param_4 + 0x418, &local_4d8);
                                if (local_4c == 0) {
                                    local_50 =
                                    ...
                                    if (local_50 != (FILE *)0x0) {
                                        printf(
                                            ...
                                            "%02X %02X %02X %02X %02X\n",
                                            (uint)(byte)param_4[0xd],
                                            (uint)(byte)param_4[0xe],
                                            (uint)(byte)param_4[0xf],
                                            (uint)(byte)param_4[0x10],
                                            (uint)(byte)param_4[0x11],
                                            (uint)(byte)param_4[0x12],
                                            (uint)(byte)param_4[0x13],
                                            (uint)(byte)param_4[0x14]);
                                        fwrite(param_4 + 0xd, 1, 8, local_50);
                                        fclose(local_50);
                                    }
                                    if (param_5 != '\0') {
                                        local_54 = fopen64(
                                        ...
                                        fwrite(param_4 + 0x18, 1, local_48,
                                               local_54);
                                        fclose(local_54);
                                        local_54 = fopen64(
                                    ...
                                    memset(auStack_8f8, 0, 0x420);
                                    SHA256_Init(&SStack_968);
                                    SHA256_Update(&SStack_968, param_4, 0x800);
                                    SHA256_Final(auStack_8f8, &SStack_968);
                                    for (local_24 = 0;
                                         local_24 < (int)(uint)local_11;
                                         local_24 = local_24 + 1) {
                                        local_64 =
                                            (uint)(byte)param_4[local_24 * 5 +
                                                                0x51e]
                                                << 0x18 |
                                            (uint)(byte)param_4[local_24 * 5 +
                                                                0x51f]
                                            ...
                                            (uint)(byte)param_4[local_24 * 5 +
                                                ...
                                                << 8 |
                                            (uint)(byte)
                                                param_4[local_24 * 5 + 0x521];
                                        FUN_00010de8(
                                            local_30, local_64,
                                            auStack_8f8 + (local_24 + 1) * 0x20,
                                            param_4[local_24 * 5 + 0x51d], 0,
                                            param_5);
                                    }
                                    for (local_28 = 0;
                                        ...
                                        FUN_00010de8(
                                            ...
                                            auStack_8f8 +
                                                (local_11 + 1 + local_28) *
                                                    0x20,
                                            param_4[local_28 * 5 + 0x51d], 1,
                                            param_5);
                                    }
                                    local_a68 = 0;
                                    memset(auStack_a64, 0, 0xfc);
                                    fseek(local_30, -0x100, 2);
                                    fread(&local_a68, 0x100, 1, local_30);
                                    local_a88[0] = '\0';
                                    local_a88[1] = '\0';
                                    local_a88[2] = '\0';
                                    local_a88[3] = '\0';
                                    ...
                                    local_a88[0x1e] = '\0';
                                    local_a88[0x1f] = '\0';
                                    SHA256_Init(&SStack_af8);
                                    SHA256_Update(&SStack_af8, auStack_8f8,
                                                  (uint)local_11 * 0x40 + 0x20);
                                    SHA256_Final(local_a88, &SStack_af8);
                                    local_58 = (BIO *)0x0;
                                    local_5c = (RSA *)0x0;
                                    local_58 =
                                    ...
                                    if (local_5c == (RSA *)0x0) {
                                        ...
                                        local_60 =
                                            RSA_verify(0x2a0, local_a88, 0x20,
                                                       (uchar *)&local_a68,
                                                       0x100, local_5c);
                                        if (local_5c != (RSA *)0x0) {
                                            RSA_free(local_5c);
                            ...
                            printf("Check FileSize Failed, FileSize Should Be "
                                   ...
                                   "Total Says[%d]\n",
                                   local_40, local_2c, local_1c, iVar4, uVar5);
                            if (local_30 != (FILE *)0x0) {
                                fclose(local_30);
                            }
                            local_4c = 10;
                        ...
                        printf("Content Doesn\'t Match![%d][%d]\n",
                               (uint)(byte)param_4[0x518], (uint)local_11,
                               (uint)local_11, iVar4, uVar5);
                        if (local_30 != (FILE *)0x0) {
                            fclose(local_30);
                        }
                        local_4c = 9;
...
undefined4 FUN_00013808(int param_1, undefined4 *param_2)
...
void FUN_00013bec(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
...
void FUN_00013c2c(char *param_1, stat64 *param_2)

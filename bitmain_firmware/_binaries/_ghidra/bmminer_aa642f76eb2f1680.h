// Data types exported from: bmminer_aa642f76eb2f1680
// Generated by Ghidra

#ifndef BMMINER_AA642F76EB2F1680_TYPES_H
#define BMMINER_AA642F76EB2F1680_TYPES_H
...
struct epoll_event {
    uint32_t events;  // offset: 0x0
    epoll_data_t data;  // offset: 0x8
}; // size: 0x10

struct glob_t {
    size_t gl_pathc;  // offset: 0x0
    char * * gl_pathv;  // offset: 0x4
    size_t gl_offs;  // offset: 0x8
    int gl_flags;  // offset: 0xc
    _func_5026 * gl_closedir;  // offset: 0x10
    _func_5027 * gl_readdir;  // offset: 0x14
    _func_5028 * gl_opendir;  // offset: 0x18
    _func_5029 * gl_lstat;  // offset: 0x1c
    _func_5030 * gl_stat;  // offset: 0x20
}; // size: 0x24
...
struct itimerspec {
    timespec it_interval;  // offset: 0x0
    timespec it_value;  // offset: 0x8
}; // size: 0x10
...
int __errfunc(char * param0, int param1);
...
void _func_5026(void * param0);
dirent * _func_5027(void * param0);
void * _func_5028(char * param0);
int _func_5029(char * param0, stat * param1);
int _func_5030(char * param0, stat * param1);

#endif // BMMINER_AA642F76EB2F1680_TYPES_H

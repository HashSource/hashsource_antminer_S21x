   ...
   <div style="text-align: center; bottom: 0; left: 0; height: 1.5em; font-size: 80%; margin: 0; padding: 5px 0px 2px 8px; background-color: #918ca0; width: 100%;">
      <font style="color:#fff;">Copyright &copy; 2013-2014, Bitmain Technologies</font>
                  ...
                  <script type="text/javascript">
                      ...
                      if(miner_type["value"] == "S17 Pro")
                          div.innerHTML = ' <input type="radio" id="ant_work_mode_0" name="ant_work_mode" value="0" /> Low Power<br> <input type="radio" id="ant_work_mode_1" name="ant_work_mode" value="1" /> Normal <br> <input type="radio" id="ant_work_mode_2" name="ant_work_mode" value="2" /> High Performance';
                      else
